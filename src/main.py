...
class app():
    ...
    def generate(self):
        ...
        with open(f'{self.packNamespace}\\function\\tick.mcfunction', 'w') as tick:
            tick.write(self.header + 'execute as @e[type=item_display,tag=' + self.packAuthor + ".custom_block] at @s run function " + self.packAuthor + ":as_blocks")
            tick.close()
