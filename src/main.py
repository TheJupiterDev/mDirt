...
class app():
    ...
    def getItemTexture(self):
        ...
        self.pixmap = QPixmap(self.itemTexture).scaled(41, 41, aspectRatioMode=True)
    ...
    def editItem(self):
        ...
        self.ui.itemTextureLabel.setPixmap(QPixmap(properties["texture"]).scaled(41, 41, aspectRatioMode=True))
    ...
    def editBlock(self):
        ...
        self.ui.frontFace.setPixmap(QPixmap(properties["texturePaths"]["2"]).scaled(41, 41, aspectRatioMode=True))
        self.ui.backFace.setPixmap(QPixmap(properties["texturePaths"]["0"]).scaled(41, 41, aspectRatioMode=True))
        self.ui.rightFace.setPixmap(QPixmap(properties["texturePaths"]["1"]).scaled(41, 41, aspectRatioMode=True))
        self.ui.leftFace.setPixmap(QPixmap(properties["texturePaths"]["3"]).scaled(41, 41, aspectRatioMode=True))
        self.ui.topFace.setPixmap(QPixmap(properties["texturePaths"]["4"]).scaled(41, 41, aspectRatioMode=True))
        self.ui.bottomFace.setPixmap(QPixmap(properties["texturePaths"]["5"]).scaled(41, 41, aspectRatioMode=True))
    ...
    def generateResourcePack(self, itemModelFile):
        ...
        for self.item in self.items:
            ...
            with open(f'{self.currentPath}\\{self.items[self.item]["name"]}.json', 'w') as file:
                if ".json" in self.items[self.item]["model"]:
                    # shutil.copy(self.items[self.item]["model"], os.path.normpath(f'{self.currentPath}\\{os.path.splitext(os.path.basename(str(self.items[self.item]["model"])))[-2]}.json'))
    ...
    def generate(self):
        ...
        with open('src\item_models.json', 'r') as f:
